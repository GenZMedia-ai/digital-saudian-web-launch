  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-devora-light via-white to-blue-50">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <Smartphone className="absolute top-1/3 right-1/6 rtl:left-1/6 rtl:right-auto text-devora-cyan/20 w-8 h-8 animate-float" style={{ animationDelay: '1.5s' }} />
        <Globe className="absolute bottom-1/3 left-1/3 rtl:right-1/3 rtl:left-auto text-green-500/20 w-8 h-8 animate-float" style={{ animationDelay: '0.5s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className={`animate-fade-in ${isRTL ? 'animate-slide-in-rtl' : ''}`}>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-hanson font-bold text-devora-navy mb-6 leading-tight">
            {t('hero.title')}
            <span className="block text-devora-primary">{t('hero.subtitle')}</span>
          </h1>
